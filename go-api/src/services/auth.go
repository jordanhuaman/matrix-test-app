...
func (s *AuthService) generateAccessToken(user *models.User) (string, error) {
	...
	claims := jwt.MapClaims{
		...
		"username": user.Email,            // custom claim
...
func (s *AuthService) LoginWithRefresh(email, password string, refreshTokenTTL time.Duration) (accessToken string, refreshToken string, err error) {
	...
	token, err := s.refreshTokenRepo.CreateRefreshToken(user.ID.String(), refreshTokenTTL)
	if err != nil {
		return "", "", err
	}
...
func (s *AuthService) RefreshAccessToken(refreshTokenString string) (accessToken string, refreshToken string, err error) {
	...
	newToken, err := s.refreshTokenRepo.CreateRefreshToken(user.ID.String(), remainingTTL)
	if err != nil {
		return "", "", err
	}
...
func (s *AuthService) RevokeAllUserRefreshTokens(userID string) error {
